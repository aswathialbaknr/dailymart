...
import slide2 from'/home/aswathi/dailymart/src/assets/KitchenSlide1.jpg'
import slide3 from'/home/aswathi/dailymart/src/assets/KitchenSlide2.jpg'
import slide4 from'/home/aswathi/dailymart/src/assets/KitchenSlide3.jpg'
import slide8 from'/home/aswathi/dailymart/src/assets/KitchenSlide4.jpg'
import veg from'/home/aswathi/dailymart/src/assets/veg.png'
import card1 from'/home/aswathi/dailymart/src/assets/Kitchen-soup-spoon-flr-set.webp'
import card2 from'/home/aswathi/dailymart/src/assets/Kitchen-skid-grip-yellow.webp'
import card3 from'/home/aswathi/dailymart/src/assets/Kitchen-tumbler-set-green.webp'
import card4 from'/home/aswathi/dailymart/src/assets/Kitchen-pressure-cooker-with-induction-compatible-base-hss50.jpg'
import card5 from'/home/aswathi/dailymart/src/assets/Kitchen-knife-lighter-peeler-vibgyor-green.jpg'
import card6 from'/home/aswathi/dailymart/src/assets/Kitchen-juicer-ras-dhara-green.jpg'
import card7 from'/home/aswathi/dailymart/src/assets/Kitchen-glassjuice-tumbler-set.webp'
import card8 from'/home/aswathi/dailymart/src/assets/Kitchen-bowl-black-green-yellow.webp'
    ...
    <div class="col-3 ">
        ...
        <div class="uk-width-expand  ">
            ...
            <label class="  category-style uk-margin-remove-bottom">Category</label>  
                <li class="uk-parent">
                <a class="parent uk-margin-remove-bottom" href="#"> Kitchen, Garden & Pets</a>
                <ul class="uk-nav-sub">
                            <li><a class="sub-head" href="#">Appliances & Electricals</a></li>
                            <li><a class="sub-head" href="#">Breakfast Cereals</a></li>
                            <li><a class="sub-head" href="#">Bakeware</a></li>
                            <li><a class="sub-head" href="#">Cookware & Non Stick</a></li>
...
<div class="uk-flex flex-style ">
    ...
    <h3 class="items ">soup-spoon-flr-set </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
    <div class="uk-flex  ">
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">bb Royal</h3>
    <h3 class="items ">Skid-grip-yellow </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">bb Royal</h3>
    <h3 class="items ">tumbler-set-green </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 Pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">bb Royal</h3>
    <h3 class="items ">Pressure-cooker-with-induction-compatible </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">bb Royal</h3>
    <h3 class="items ">knife-lighter-peeler-vibgyor-green  </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">bb Royal</h3>
    <h3 class="items ">glassjuice-tumbler-set </h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <h3 class="items ">bowl-black-green-yellow</h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 pcs Rs:20.00</option>
        <option>2 pcs Rs:40.00</option>
     </select>
