...
import card5 from'/home/aswathi/dailymart/src/assets/avocado.webp'
import veg from'/home/aswathi/dailymart/src/assets/veg.png'
import card6 from'/home/aswathi/dailymart/src/assets/apple.webp'
import card7 from'/home/aswathi/dailymart/src/assets/banana.webp'
...
{/* side nave and main section */}
            ...
            <div class="col-3 ">
                ...
                <div class="uk-width-expand uk-margin-large-top">
                    ...
                    <label class="  category-style uk-margin-remove-bottom">Category</label>  
                        ...
                        <ul class="uk-nav-sub">
                            <li><a class="sub-head" href="#">Fresh Fruits</a></li>
                            <ul class="uk-nav-sub">
    ...
    <ul class="uk-list">
        ...
        <div class="uk-flex flex-style ">
            ...
            <h3 class="items ">Capsicum-green</h3><br/>
        ...
        <div class="uk-flex flex-style ">
            <div class="uk-margin-right">
            <button class="uk-button uk-margin-top  uk-button-default uk-width-expand off "> GET 24% OFF </button> 
            <img src={card11} className="  "  alt="slide1"/><br/>
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style ">
            <div class="uk-margin-right">
            <button class="uk-button uk-margin-top  uk-button-default uk-width-expand off "> GET 24% OFF </button> 
            <img src={card9} className="  "  alt="slide1"/><br/>
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style ">
            <div class="uk-margin-right">
            <button class="uk-button uk-margin-top  uk-button-default uk-width-expand off "> GET 24% OFF </button> 
            <img src={card10} className="  "  alt="slide1"/><br/>
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style ">
            <div class="uk-margin-right">
            <button class="uk-button uk-margin-top  uk-button-default uk-width-expand off "> GET 24% OFF </button> 
            <img src={card12} className="  "  alt="slide1"/><br/>
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
