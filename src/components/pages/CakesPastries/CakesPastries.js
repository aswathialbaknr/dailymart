...
import './CakesPastries.css';
import veg from'/home/aswathi/dailymart/src/assets/veg.png'
import card1 from'/home/aswathi/dailymart/src/assets/muffincup-cake-vanilla.jpg'
import card2 from'/home/aswathi/dailymart/src/assets/Macarons-frozen.jpg'
import card3 from'/home/aswathi/dailymart/src/assets/ice-cream-cake.jpg'
import card4 from'/home/aswathi/dailymart/src/assets/fruit-tea-cake.jpg'
import card5 from'/home/aswathi/dailymart/src/assets/Cheese-cake-frozen-eggless.jpg'
import card6 from'/home/aswathi/dailymart/src/assets/Cheese-cake-frozen-eggless.jpg'
import card7 from'/home/aswathi/dailymart/src/assets/muffincup-cake-vanilla.jpg'
import card8 from'/home/aswathi/dailymart/src/assets/tea-cake-blueberry-crumble.jpg'
import Header from'../../header/Header'
import Footer from'../../footer/Footer'
 
function CakesPastries() {
    ...
    <div class="col-3 ">
        ...
        <div class="uk-width-expand  ">
            ...
            <label class="  category-style uk-margin-remove-bottom">Category</label>  
                <li class="uk-parent">
                <a class="parent uk-margin-remove-bottom" href="#">Cakes & Pastries</a>
                <ul class="uk-nav-sub">
...
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Bauli</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Britannia</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
...
<div class="row  "> 
<div class="col-9">
<label class="header-label ">Cakes & Pastries</label>  
</div>
<div class="col-3">
