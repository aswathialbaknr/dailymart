...
import card1 from'/home/aswathi/dailymart/src/assets/amul-butter.webp'
import card2 from'/home/aswathi/dailymart/src/assets/amul-fresh-paneer.webp'
import card3 from'/home/aswathi/dailymart/src/assets/cheese-melto.jpg'
import card4 from'/home/aswathi/dailymart/src/assets/good-day-butter-cookies.jpg'
import card5 from'/home/aswathi/dailymart/src/assets/ice-cream-cake.jpg'
import card6 from'/home/aswathi/dailymart/src/assets/ice-cream-cone-strawberry-swirl-cake.jpg'
import card7 from'/home/aswathi/dailymart/src/assets/mango-ice-cream-jumbo.jpg'
import card8 from'/home/aswathi/dailymart/src/assets/milk.webp'
import Header from'../../header/Header'
import Footer from'../../footer/Footer'
 
function BakeryCakesDairy() {
...
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">American Bagel</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Factory Amul</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Amul Gold</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Amul Moti</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Abbies</label></label>
</li>
<li><label><input class="uk-checkbox  " type="checkbox"/> &nbsp;&nbsp;
    <label class="  chech-text">Amul SlimAl' FezAmbrosia</label></label>
</li>
</ul>
</div>
</div>
