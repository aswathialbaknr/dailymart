...
import card1 from'/home/aswathi/dailymart/src/assets/sprouts-moong.webp'
import card2 from'/home/aswathi/dailymart/src/assets/tender-coconut.webp'
import card3 from'/home/aswathi/dailymart/src/assets/sprouts-channa.webp'
import card4 from'/home/aswathi/dailymart/src/assets/carrots-diced.webp'
import card5 from'/home/aswathi/dailymart/src/assets/pineapple-chunks.webp'
import veg from'/home/aswathi/dailymart/src/assets/veg.png'
import card6 from'/home/aswathi/dailymart/src/assets/cut-mushroom.webp'
import card7 from'/home/aswathi/dailymart/src/assets/ladies-finger.webp'
// import card8 from'/home/aswathi/dailymart/src/assets/carrot.webp'
// import card9 from'//home/aswathi/dailymart/src/assets/grapes.webp'
...
{/* side nave and main section */}
            ...
            <div class="uk-margin-left uk-padding-remove-right">
                <div class="uk-width-expand uk-margin-large-top">
                    ...
                    <label class="  category-style uk-margin-remove-bottom">Category</label>  
                        ...
                        <ul class="uk-nav-sub">
                            <li><a class="sub-head" href="#">Cuts & Sprouts</a></li>
                            <ul class="uk-nav-sub">
    ...
    <ul class="uk-list">
        ...
        <div class="col-9">
        <label class="header-label   ">Cuts & Sprouts</label>  
        </div>
        <div class="col-3">
        ...
        <div class="uk-flex flex-style ">
            ...
            <h3 class="items ">Sprouts - Moong Green</h3><br/>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items ">Tender Coconut - Medium</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items ">Sprouts - Channa Brown</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items ">Carrots - Diced</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items ">Pineapple - Chunks, Single Serve</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items "> Cut - Mushroom</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
        ...
        <div class="uk-flex flex-style ">
            ...
            <img src={veg} className=" veg-size"  alt="slide1"/>
            <h3 class="uk-text-muted fresho ">Fresho</h3>
            <h3 class="items ">Ladies Finger - Diced</h3><br/>
            <select class="uk-select mrp-style uk-height-small">
                <option>1 Kg Rs:20.00</option>
                <option>2 Kg Rs:40.00</option>
             </select>
