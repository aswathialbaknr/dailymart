...
import './EnergySoftDrinks.css';
import slide1 from'/home/aswathi/dailymart/src/assets/EnergySlide.jpg'
import veg from'/home/aswathi/dailymart/src/assets/veg.png'
import card1 from'/home/aswathi/dailymart/src/assets/Ecoca-cola-soft-drink.webp'
import card2 from'/home/aswathi/dailymart/src/assets/Edrink-black-slim.webp'
import card3 from'/home/aswathi/dailymart/src/assets/Esoft-drink.jpg'
import card4 from'/home/aswathi/dailymart/src/assets/coca-cola-soft-drink-original-taste.webp'
import card5 from'/home/aswathi/dailymart/src/assets/Ecoca-cola-soft-drink.webp'
import card6 from'/home/aswathi/dailymart/src/assets/Edrink-black-slim.webp'
import card7 from'/home/aswathi/dailymart/src/assets/Esoft-drink.jpg'
import card8 from'/home/aswathi/dailymart/src/assets/coca-cola-soft-drink-original-taste.webp'
import Header from'../../header/Header'
import Footer from'../../footer/Footer'
 
function EnergySoftDrinks() {
...
<div class="uk-flex flex-style ">
    ...
    <h3 class="items ">Amul-butter</h3><br/>
...
<div class="uk-flex flex-style ">
    ...
    <h3 class="items ">Amul-fresh-paneer</h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 Kg Rs:20.00</option>
        <option>2 Kg Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">Amul</h3>
    <h3 class="items ">Cheese-melto</h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 Kg Rs:20.00</option>
        <option>2 Kg Rs:40.00</option>
     </select>
...
<div class="uk-flex flex-style ">
    ...
    <img src={veg} className=" veg-size"  alt="slide1"/>
    <h3 class="uk-text-muted fresho ">Amul</h3>
    <h3 class="items ">Good-day-butter-cookies</h3><br/>
    <select class="uk-select mrp-style uk-height-small">
        <option>1 Kg Rs:20.00</option>
        <option>2 Kg Rs:40.00</option>
     </select>
...
export default EnergySoftDrinks;